import {RunResponse, RunResponseWithRecords} from '@data/decoders/RunDecoder'
 ...
 */
export function mapRun(data: io.TypeOf<typeof RunResponse>, localId: string = data.id): RunRecord {
  return {
    id: data.id,
    localId,
    userId: data.userId,
